...
var model = {
  ...
  columns: {
	 "QUICK": {
      ...
      active: false,
      icon: 'style',
      items: [{title: "HEN 2.1.3", desc: "Inc: 7.02 PSVR spoof, Debug Trophies Support, Enable UART, Remote Play Enabler", version: "2.1.3 by SiSTRo", active: false, icon: "", expage: "payloads/Hen213.html" }, { title: "BINLOADER", desc: "Enable only BIN LOADER function on port:9020", version: "1.0 by Specter", active: false, icon: "send", expage: "payloads/binloader.html" }, { title: "FTP SERVER", desc: "Start an ftp server and connect to your PC to your PS4", version: "1.3 by xVortex", active: false, icon: "wifi", expage: "payloads/vtxftp.html"}, { title: "DUMPER", desc: "Dump disc/PSN games to USB: with/without patches, merged/unmerged", version: "1.8 by xVortex", active: false, icon: "archive", expage: "payloads/vtxdump.html"}]
    },
    "HEN": {
      index: 1,
      title: "HEN",
...
onkeydown = function(f){
     ...
     if(map[117] && map[37]){window.open("payloads/Hen213.html", "content");} // R1 + D-Pad Left
